    ...
    <section className="py-20 px-4 relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto text-center max-w-4xl relative z-10">
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight min-h-[200px] md:min-h-[240px]"
          style={{
        ...
        >
          ...
          {showCursor && (
            <motion.span
              ...
              className="inline-block w-1 h-12 md:h-16 bg-blue-400 ml-2 shadow-lg"
            />
          )}
        </motion.h1>
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg rounded-full shadow-2xl hover:shadow-blue-500/25 duration-300 relative overflow-hidden border-2 border-blue-500/20"
