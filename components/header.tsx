    ...
    >
      <div className="container mx-auto p-2 md:px-16 md:py-5 md:pt-6">
        <div className="flex items-center justify-between px-4 md:px-12">
          ...
          >
            <Link href="https://calendly.com/hitmarkdigital">
              Book Strategy Call
            </Link>
          </Button>
              ...
              <SheetTitle>
                <SheetTrigger asChild className="bg-transparent">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="lg:hidden p-2 bg-gray-40 hover:bg-gray-100 "
                  >
                ...
                <div className="flex flex-col h-full">
                  <nav className="flex-1 py-6 space-y-6 overflow-y-auto">
                    ...
                    <div className="space-y-3">
                      <h3 className="font-semibold text-upgrow-purple text-base">
                        What We Do
                      </h3>
